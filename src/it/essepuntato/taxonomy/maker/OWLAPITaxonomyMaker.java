package it.essepuntato.taxonomy.maker;
...
public class OWLAPITaxonomyMaker implements ITaxonomyMaker{
	   ...
	   public OWLAPITaxonomyMaker(String uri, boolean useImports){
	   ...
	   public OWLAPITaxonomyMaker(InputStream uri, boolean useImports){
	   ...
	   public OWLAPITaxonomyMaker(StringDocumentSource content, boolean useImports){
		...
		public HTaxonomy makeTaxonomy() {
			...
			if (isOneRoot) {
				...
				root = new Category(OWLAPITaxonomyMaker.rootName);
			}
			try {
				t.addCategory(root);
				t.setRoot(root);
